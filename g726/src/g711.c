...
/*
  ...
  ==========================================================================
*/
void            alaw_compress(lseg, _linbuf, _logbuf)
  long            lseg;
  short          *_linbuf;
  short          *_logbuf;
{
...
/*
  ...
  ============================================================================
*/
void            alaw_expand(lseg, _logbuf, _linbuf)
  long            lseg;
  short          *_linbuf;
  short          *_logbuf;
{
...
/*
  ...
  ==========================================================================
*/
void            ulaw_compress(lseg, _linbuf, _logbuf)
  long            lseg;
  short          *_linbuf;
  short          *_logbuf;
{
...
//void            ulaw_expand(lseg, _logbuf, _linbuf)
//  long            lseg;
//  short          *_logbuf;
//  short          *_linbuf;
//{
...
void  ulaw_expand(long lseg, short * _logbuf, short * _linbuf)
{
	...
	for (n = 0; n < lseg; n++)
	{
    	...
    	sign = ((logbuf[n]>>6)&2)-1;	/* sign-bit = 1 for positiv values */

    	mantissa = (~logbuf[n])&(0x007F);	/* 1's complement of input value */
    ...
    /* Compute Quantized Sample (14 bit left justified!) */
    	...
    	mantissa <<= (exponent+1);	
    	linbuf[n] = sign*(mantissa+step-(4*33));
	}
}

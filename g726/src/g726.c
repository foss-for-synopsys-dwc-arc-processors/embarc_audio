...
# define __XY __xy
#else //if !defined(_ARC) || !defined(core_config_xy)
# define __XY
#endif //if defined(_ARC) && defined(core_config_xy)

#if !defined(_ARC)
# define _max(a,b)    (((a) > (b)) ? (a) : (b))
# define _min(a,b)    (((a) < (b)) ? (a) : (b))
#define _ALWAYS_INLINE
#else //#if defined(_ARC)
...
static void G726_accum ARGS((short *wa1, short *wa2, short *wb1, short *wb2, short *wb3, short *wb4, short *wb5, short *wb6, short *se, short *sez));
static void G726_addb ARGS((short *dq, short *se, short *sr));
static void G726_addc ARGS((short *dq, short *sez, short *pk0, short *sigpk));
static void G726_floata ARGS((short *dq, short *dq0));
static void G726_floatb ARGS((short *sr, short *sr0));
static void G726_fmult ARGS((short *An, short *SRn, short *WAn));
static void G726_limc ARGS((short *a2t, short *a2p));
static void G726_limd ARGS((short *a1t, short *a2p, short *a1p));
...
/*
 ...
 ----------------------------------------------------------------------------
*/
void            G726_encode(_inp_buf, _out_buf, smpno, law, rate, r, state)
  short          *_inp_buf, *_out_buf;
  long            smpno;
  char           *law;
  short           r;
  short           rate;
  G726_state     *state;
{
  ...
  long            j;
    __XY short * __restrict inp_buf = (__XY short * __restrict)_inp_buf;
    __XY short * __restrict out_buf = (__XY short * __restrict)_out_buf;
...
/*
 ...
 ----------------------------------------------------------------------------
*/
void            G726_decode(_inp_buf, _out_buf, smpno, law, rate, r, state)
  short          *_inp_buf, *_out_buf;
  long            smpno;
  char           *law;
  short           r;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_expand(s, law, sl)
  short          *s;
  char           *law;
  short          *sl;
{
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_subta(sl, se, d)
  short          *sl, *se, *d;
{
  long            se1;
  long            sl1, sei, sli;
...
/*
  ...
  --------------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_log(d, dl, ds)
  short          *d, *dl, *ds;
{
  long            mant;
  long            d1;
  ...
  *ds = (*d >> 15);
  ...
  /* Compute exponent */
#if defined(__Xnorm) && defined(REMAPITU_T)
	exp_ = dqm?_fls(dqm):0;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_quan(rate, dln, ds, i)
  short          *dln, *ds, *i;
  short           rate;
{
  if (rate == 4)
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_subtb(dl, y, dln)
  short          *dl, *y, *dln;
{
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_adda(dqln, y, dql)
  short          *dqln, *y, *dql;
{
  *dql = (*dqln + (*y >> 2)) & 4095;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_antilog(dql, dqs, dq)
  short          *dql, *dqs, *dq;
{
  long            dqmag;
  long            ds, dmn, dex, dqt;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_reconst(rate, i, dqln, dqs)
  short          *i, *dqln, *dqs;
  short           rate;
{
  if (rate == 4)
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_delaya(r, x, y)
  short          *r, *x, *y;
{
  *y = (*r == 0) ? *x : 0;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_delayb(r, x, y)
  short          *r, *x, *y;
{
  *y = (*r == 0) ? *x : 544;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_delayc(r, x, y)
  short          *r;
  long           *x, *y;
{
  *y = (*r == 0) ? *x : 34816;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_delayd(r, x, y)
  short          *r, *x, *y;
{
  *y = (*r == 0) ? *x : 32;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_filtd(wi, y, yut)
  short          *wi, *y, *yut;
{
  long            difs, difsx;
  long            y1;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_filte(yup, yl, ylp)
  short          *yup;
  long           *yl, *ylp;
{
  long            difs, difsx;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_functw(rate, i, wi)
  short          *i, *wi;
  short           rate;
{
  if (rate == 4)
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_limb(yut, yup)
  short          *yut, *yup;
{
  short           gell, geul;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_mix(al, yu, yl, y)
  short          *al, *yu;
  long           *yl;
  short          *y;
{
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_filta(fi, dms, dmsp)
  short          *fi, *dms, *dmsp;
{
  short           difs, difsx;
  short           dif;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_filtb(fi, dml, dmlp)
  short          *fi, *dml, *dmlp;
{
  long            difs, difsx;
  long            fi1;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_filtc(ax, ap, app)
  short          *ax, *ap, *app;
{
  short           difs, difsx;
  short           dif;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_functf(rate, i, fi)
  short          *i, *fi;
  short           rate;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_lima(ap, al)
  short          *ap, *al;
{
  *al = _min(*ap, 256);
  *al >>= 2;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_subtc(dmsp, dmlp, tdp, y, ax)
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_triga(tr, app, apr)
  short          *tr, *app, *apr;
{
  *apr = (*tr == 0) ? (*app) : 256;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_accum(wa1, wa2, wb1, wb2, wb3, wb4, wb5, wb6, se, sez)
...
/*
 ----------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_addb(dq, se, sr)
  short          *dq, *se, *sr;
{
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_addc(dq, sez, pk0, sigpk)
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_floata(dq, dq0)
  short          *dq, *dq0;
{
  long            mant;
  long            mag, exp_;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_floatb(sr, sr0)
  short          *sr, *sr0;
{
  long            mant;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_fmult(An, SRn, WAn)
  short          *An, *SRn, *WAn;
{
...
static _ALWAYS_INLINE void            G726_limc(a2t, a2p)
  short          *a2t, *a2p;
{
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_limd(a1t, a2p, a1p)
  short          *a1t, *a2p, *a1p;
{
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_trigb(tr, ap, ar)
  short          *tr, *ap, *ar;
{
  *ar = (*tr == 0) ? *ap : 0;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_upa1(pk0, pk1, a1, sigpk, a1t)
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_upa2(pk0, pk1, pk2, a2, a1, sigpk, a2t)
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_upb(rate, u, b, dq, bp)
  short          *u, *b, *dq, *bp;
  short           rate;
{
  short           dqmag;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_xor(dqn, dq, u)
  short          *dqn, *dq, *u;
{
  short           dqns;
  short           dqs;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_tone(a2p, tdp)
  short          *a2p, *tdp;
{
  long            a2p1;
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_trans(td, yl, dq, tr)
  short          *td;
  long           *yl;
  short          *dq, *tr;
{
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_compress(sr, law, sp)
  short          *sr;
  char           *law;
  short          *sp;
{
...
/*
 ...
 ----------------------------------------------------------------------
*/
static _ALWAYS_INLINE void            G726_sync(rate, i, sp, dlnx, dsx, law, sd)
  short          *i, *sp, *dlnx, *dsx;
  char           *law;
  short          *sd;
  short           rate;
{
  short           mask = 0, id = 0, im = 0, is = 0, ss = 0;

...
long read_bit(short *patt, long n, FILE *F, char type)
{
  ...
  /* Allocate memory */
  if ((bits = (char *)CALLOC(bits, (nbytes * sizeof(char))))==NULL)
...
FILE *F;
{
  ...
  /* Allocate memory */
  if ((byte = (char *)CALLOC(byte, (n * sizeof(char))))==NULL)
...
/*
  ...
  01.Jun.05  v.1.1  Bug correction: switch is made on the "unsigned short" value
					(v.1.0: "unsigned" only). <Cyril Guillaum� & St�phane Ragot -- stephane.ragot@rd.francetelecom.com>
  -------------------------------------------------------------------------- 
*/
char check_eid_format(FILE *F, char *file, char *type)
{

...
static __inline Word16 lshl( Word16 var1, Word16 var2) {
  return fx_asl_q15(var1, var2);
}
static __inline Word16 lshr( Word16 var1, Word16 var2) {
  return fx_asr_q15(var1, var2);
}
#else

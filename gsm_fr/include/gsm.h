...
#ifdef REMAPITU_T
#include <basop32.h>
static inline word gsm_add GSM_P((word a, word b)) {return add GSM_P((a, b));}
static inline word gsm_sub GSM_P((word a, word b)){return sub GSM_P(( a,  b));};
static inline word gsm_mult GSM_P((word a, word b)){return mult GSM_P(( a,  b));};
static inline word gsm_mult_r GSM_P((word a, word b)){return mult_r GSM_P(( a,  b));};
static inline word gsm_abs GSM_P((word a)){return abs_s GSM_P(( a));};
static inline longword gsm_L_mult GSM_P((word a, word b)){return L_mult GSM_P(( a,  b));};
static inline longword gsm_L_add GSM_P((longword a, longword b)){return L_add GSM_P(( a,  b));};
static inline longword gsm_L_sub GSM_P((longword a, longword b)){return L_sub GSM_P(( a,  b));};
static inline word gsm_norm GSM_P((longword a)){return norm_l GSM_P(( a));};
static inline longword gsm_L_asl GSM_P((longword a, int n)){return L_shl GSM_P(( a,  n));};
static inline word gsm_asl GSM_P((word a, int n)){return shl GSM_P(( a,  n));};
static inline longword gsm_L_asr GSM_P((longword a, int n)){return L_shr GSM_P(( a,  n));};
static inline word gsm_asr GSM_P((word a, int n)){return shr GSM_P(( a,  n));};
#else

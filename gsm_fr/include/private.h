...
#else
#include <basop32.h>
# define GSM_MULT_R(a, b)	mult_r(a, b)
# define GSM_MULT(a, b)		mult(a, b)
# define GSM_L_MULT(a, b)	L_mult(a, b)

# define GSM_L_ADD(a, b)	L_add(a, b)
# define GSM_ADD(a, b)		add(a, b)
# define GSM_SUB(a, b)		sub(a, b)

# define GSM_ABS(a)		abs_s(a)
#endif /*_ARC*/
/*
